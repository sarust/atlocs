module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      location.bookings.end_during(start_time, end_time),
      location.bookings.start_during(start_time, end_time),
      location.bookings.happening_during(start_time, end_time),
      location.bookings.enveloping(start_time, end_time),
      location.bookings.identical(start_time, end_time)
    ].flatten
